...
def to_surface(message):
    # gets a string and turns it to a surface of a message
    # if its a tuple, consider first cell as sender and second cell content of the message
...
def send_message(events):
        # send message to the person or invite him to a game
        # using the connection between this window to the app window
